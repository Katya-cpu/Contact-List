...
template <> constexpr inline auto FilterProxyModel::qt_create_metaobjectdata<qt_meta_tag_ZN16FilterProxyModelE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<FilterProxyModel, qt_meta_tag_ZN16FilterProxyModelE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject FilterProxyModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QSortFilterProxyModel::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FilterProxyModelE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FilterProxyModelE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16FilterProxyModelE_t>.metaTypes,
    nullptr
} };
...
void FilterProxyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FilterProxyModel::*)()>(_a, &FilterProxyModel::filterTextChanged, 0))
            return;
    }
...
void *FilterProxyModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16FilterProxyModelE_t>.strings))
...
// SIGNAL 0
void FilterProxyModel::filterTextChanged()
{
